...
public class SysDeptController extends BaseController
{
    ...
    {
        List<SysDept> deptList = deptService.selectSysDeptList(dept);
        return deptList;
    }
     ...
     * 选择机构树
     */
    @GetMapping(value = { "/selectDeptTree/{deptId}/{ancestors}","/selectDeptTree/"})
    public String selectDeptTree(@PathVariable(value = "deptId", required = false) Long deptId,@PathVariable(value = "ancestors", required = false) String ancestors, ModelMap mmap)
    {
     ...
     * 加载机构列表树
     */
    @GetMapping(value = { "/treeData/{ancestors}","/treeData/"})
    @ResponseBody
    public List<Ztree> treeData(@PathVariable(value = "ancestors", required = false) String ancestors)
    {
        SysDept sysDept=new SysDept();
        if (ancestors != null) {
            sysDept.setAncestors(ancestors);
